...
for trait in traits:
    for region in regions:
        ...
        # Load the model
        model = joblib.load("E:/learning resource/PhD/HPC_Results/RF_region/new_complete_model/models/"+trait+"_RF_"+region+"_model.json")
...
# write to csv by tab
importances.to_csv("E:/learning resource/PhD/HPC_Results/RF_region/new_complete_model/RF_SNP_importances.csv",sep="\t",index=False)
