...
do
traitIdx=$(($trait+1))
python $composer/GS_composer.py --config "$config" --mpheno $traitIdx --trait ${traits[$trait]} --model "MultiLevel Attention" --out "${wheat_path}/MultiLevelAttention/" --batch 24 --numDecay 5000 --lr
