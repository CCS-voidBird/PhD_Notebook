...
python $composer/GS_composer.py --ped $geno --pheno $pheno --mpheno 1 --index $index --trait $trait --width 256 --depth 1 --model "MultiLevel Attention" -o $target --quiet 1 --plot --epoch 30 --round 1 --locallyConnect 16 --embedding 16 --batch 256 --num-heads 1 --locallyBlock 1 --vindex $idx --lr 0.001 --loss $loss
done
